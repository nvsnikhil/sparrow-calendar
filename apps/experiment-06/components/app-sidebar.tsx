...
const data = {
  user: {
    name: "Survey Sparrow",
    email: "survey@sparrow.com",
    avatar:
      "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRx2kyyGNdGT_Y5Hv9YUtGEVfuBvkQMwq3XGNRQprJ7X7U5n3EqKmnRgwO0MWYYBt5LuZ8&usqp=CAU",
  },
};
